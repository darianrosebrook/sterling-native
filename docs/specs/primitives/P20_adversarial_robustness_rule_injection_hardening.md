...
Status: v0.3-draft  
Primary proving rigs: Rig A, Rig B, Rig D  
Last updated: 2026-01-31
## 1. Problem shape

many domains are client-defined at solve time. You need input validation, boundedness, and “no untrusted semantics” guarantees.
...
- UntrustedDomainInput -> ValidatedDomainSpec (schema/version gated)
- Boundedness constraints (caps, cost bounds, operator count)
- SecurityPolicy: deny-by-default; allowlist semantics
## 3. What must be proven

- Malformed or malicious rules are rejected; no silent semantics change
