...
Status: v0.3-draft  
Primary proving rigs: Rig I, Rig N  
Last updated: 2026-01-31
## 1. Problem shape

This primitive defines a domain-agnostic reasoning capability shape. It should be implementable with typed operators, canonical state, deterministic traces, and certifiable gates.
