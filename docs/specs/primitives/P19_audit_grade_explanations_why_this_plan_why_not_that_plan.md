...
Status: v0.3-draft  
Primary proving rigs: Rig A, Rig B, Rig C, Rig D, Rig E, Rig F, Rig G, Rig H, Rig I, Rig J, Rig L, Rig M, Rig N  
Last updated: 2026-01-31
## 1. Problem shape

if Sterling is a proving ground for trustworthy reasoning, you want structured rationales: which constraints bound the choice, which evidence updated beliefs, which alternatives were rejected and why.
...
- ExplanationBundle: constraints, legality checks, competing alternatives, evidence citations
- Deterministic rendering from trace + artifacts
## 3. What must be proven

- A third party can replay and understand: why this plan, why not another, under what constraints
